...
- Machine-report digest: `sha256:ad840bd47e1a9290f8c02f323a02e3033e8f37d834de4b0f979365353dc5235d`

## Governed workers

- `WU-FIXTURE-BACKEND` / `backend-1`: session `session-alpha17-worker-backend`, jj change `zpmkmyxpnxwnrspoptmyorolmllorqow`, scope `backend`, changed `backend/result.json`.
- `WU-FIXTURE-FRONTEND` / `frontend-1`: session `session-alpha17-worker-frontend`, jj change `orzrnnkoqmnprvtpvvxlvkutzknwypow`, scope `frontend`, changed `frontend/result.json`.

## Integration and qualification

- Integration mode: `CONTENT_NEUTRAL_DISJOINT_PATHS`
- Integrated paths: `backend/result.json, frontend/result.json`
- Frozen candidate: `sha256:5e3276c090855623cad48d7a13901262f1b5f9d81631d489a55c926059b6bf5a`
...
- `A17-014-advertised-governance-surfaces-bound`: `PASS`
- `A17-015-report-inputs-complete`: `PASS`
