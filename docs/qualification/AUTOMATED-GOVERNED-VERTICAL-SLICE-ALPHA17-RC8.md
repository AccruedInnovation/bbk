...
- Machine-report digest: `sha256:2a2cd430e51f164d346ebbd317b1fd8e2e32f6be98aa91d1b79fe1b79fb88a71`

## Governed workers

- `WU-FIXTURE-BACKEND` / `backend-1`: session `session-alpha17-worker-backend`, jj change `qtxrtopxotywowyxrlypxomlpmqtwxls`, scope `backend`, changed `backend/result.json`.
- `WU-FIXTURE-FRONTEND` / `frontend-1`: session `session-alpha17-worker-frontend`, jj change `pxnxtopnuksrsypwnqluqkvnmlmsrsuv`, scope `frontend`, changed `frontend/result.json`.

## Integration and qualification

- Integration mode: `CONTENT_NEUTRAL_DISJOINT_PATHS`
- Integrated paths: `backend/result.json, frontend/result.json`
- Frozen candidate: `sha256:c5dfb83578d60bace94339f8e893f022b4c2a47b036ed76ceb11e518864c3dec`
