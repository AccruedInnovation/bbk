...
- `bbk-worker` (canonical `bbk_worker`) — when one bounded work unit has exact subject, workspace, ownership, profiles, tools, authority, checks, continuation policy, and handoff.
