...
- `bbk-validator` (canonical `bbk_validator`) — Evaluate exact named assertions against one exact candidate and return immutable findings without repairing the subject.
