...
- Project every substantive territory execution-state transition and compact territory handoff pointer through mandatory `bbk-beads`; do not treat tracker status as territory completion, candidate admission, or assurance disposition, and preserve typed projection failures for deterministic correction.
