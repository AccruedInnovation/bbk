...
<bbk-role-contract role="bbk_phase_wayfinder" package-version="0.1.0-alpha.13.1">
...
Additional procedures available on demand: `bbk-execution-slicing`, `bbk-implementation-structure`, `bbk-profile-routing`, `bbk-installed-profiles`, `bbk-state-decision-effect-design`, `bbk-review-plan`, `bbk-procedure-design`, `bbk-context-routing`, `bbk-handoff`. Load one only when its method is material to the assigned responsibility.
