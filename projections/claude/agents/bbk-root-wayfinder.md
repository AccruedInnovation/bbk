...
color: blue
tools:
  - "Agent(bbk-territory-wayfinder, bbk-questioning-wayfinder, bbk-researcher, bbk-prototyper, bbk-synthesizer, bbk-architect, bbk-verification-designer, bbk-worker-designer, bbk-reviewer, bbk-root-orchestrator)"
  - "Read"
  - "Grep"
  - "Glob"
  - "Bash"
...
- `bbk-root-orchestrator` (canonical `bbk_root_orchestrator`) — Coordinate execution of an approved BBK operating baseline across territories, dependencies, integration points, evidence, and user-facing status.
