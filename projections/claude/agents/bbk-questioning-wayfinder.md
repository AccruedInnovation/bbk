...
- Project every substantive question-branch and decision-request coordination record through mandatory `bbk-beads`; preserve request identity, authoritative responses, accepted decisions, and branch closure in BBK rather than tracker workflow state, and retain typed projection failures for deterministic correction.
