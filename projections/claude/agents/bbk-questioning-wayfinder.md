...
- `bbk-question-guide` (canonical `bbk_question_guide`) — Resolve one declared material decision through a focused one-question-at-a-time conversation with a recommendation, explicit disposition, and ADR-compatible return packet.
