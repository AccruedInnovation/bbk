...
Use the installed BBK skills applicable to this invocation: `bbk`, `bbk-review`, `bbk-evidence`, `bbk-solution-outcome-fit`, `bbk-implementation-structure`, `bbk-execution-slicing`, `bbk-profile-routing`, `bbk-installed-profiles`, `bbk-review-plan`, `bbk-review-context`, `bbk-review-run`, `bbk-review-findings`, `bbk-review-intent`, `bbk-context-routing`. Load only the procedure content needed for the current responsibility.
...
- `bbk_validator` — Evaluate exact named assertions against one exact candidate and return immutable findings without repairing the subject.
