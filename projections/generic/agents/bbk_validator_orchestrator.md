...
- `bbk_validator` — when one non-overlapping assertion charter needs exact candidate-bound evaluation and immutable evidence.
- `bbk_reviewer` — when a qualitative, cross-cutting, or independently reasoned charter is required in addition to exact validator assertions.
