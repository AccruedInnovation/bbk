...
Use the installed BBK skills applicable to this invocation: `bbk`, `bbk-plan`, `bbk-implementation-structure`, `bbk-execution-slicing`, `bbk-profile-routing`, `bbk-installed-profiles`, `bbk-state-decision-effect-design`, `bbk-review-plan`, `bbk-review-context`, `bbk-context-routing`, `bbk-procedure-design`. Load only the procedure content needed for the current responsibility.
