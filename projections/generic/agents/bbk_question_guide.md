...
Use the installed BBK skills applicable to this invocation: `bbk`, `bbk-plan`, `bbk-solution-outcome-fit`, `bbk-state-decision-effect-design`, `bbk-procedure-design`, `bbk-context-routing`. Load only the procedure content needed for the current responsibility.
