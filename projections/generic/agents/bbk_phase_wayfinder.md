...
Use the installed BBK skills applicable to this invocation: `bbk`, `bbk-plan`, `bbk-execution-slicing`, `bbk-profile-routing`, `bbk-installed-profiles`, `bbk-state-decision-effect-design`, `bbk-review-plan`, `bbk-procedure-design`, `bbk-context-routing`. Load only the procedure content needed for the current responsibility.
