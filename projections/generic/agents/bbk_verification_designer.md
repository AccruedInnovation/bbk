...
Use the installed BBK skills applicable to this invocation: `bbk`, `bbk-plan`, `bbk-evidence`, `bbk-solution-outcome-fit`, `bbk-implementation-structure`, `bbk-execution-slicing`, `bbk-state-decision-effect-design`, `bbk-review-plan`, `bbk-review-context`, `bbk-review-intent`, `bbk-profile-routing`, `bbk-installed-profiles`, `bbk-context-routing`, `bbk-procedure-design`. Load only the procedure content needed for the current responsibility.
