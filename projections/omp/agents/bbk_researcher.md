...
<bbk-agent-system role="bbk_researcher" package-version="0.1.0-alpha.13.1">
...
Additional procedures available on demand: `bbk-context-routing`, `bbk-handoff`. Load one only when its method is material to the assigned responsibility.
