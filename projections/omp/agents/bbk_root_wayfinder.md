...
description: "Own the whole BBK planning conversation, establish the operational outcome, map territories, route material decisions through bounded questioning, and synthesize an executable operating baseline."
model: "openai-codex/gpt-5.6-sol"
thinkingLevel: "high"
autoloadSkills: bbk, bbk-plan, bbk-solution-outcome-fit, bbk-implementation-structure, bbk-execution-slicing, bbk-profile-routing, bbk-installed-profiles, bbk-state-decision-effect-design, bbk-review-plan, bbk-review-intent, bbk-procedure-design, bbk-context-routing
spawns: bbk_territory_wayfinder, bbk_questioning_wayfinder, bbk_researcher, bbk_prototyper, bbk_synthesizer, bbk_architect, bbk_verification_designer, bbk_worker_designer, bbk_reviewer, bbk_root_orchestrator
---
