...
- `bbk_verification_designer` — when phase exit claims or integration obligations need explicit assertions and evidence methods.
- `bbk_worker_designer` — when a phase work unit needs an exact worker invocation, profile, tool, authority, and handoff contract.
- `bbk_reviewer` — when an independent phase-plan review can retire a material execution or assurance risk.
