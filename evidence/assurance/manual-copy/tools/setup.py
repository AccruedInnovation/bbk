...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="derive Codex routes from the packaged canonical OMP default table",
    )
    parser.add_argument(
...
def install_arguments(
    ...
    *,
    ...
    if getattr(args, "codex_use_packaged_omp_default_routing", False):
        values.append("--codex-use-packaged-omp-default-routing")
...
def _validate_options(parser: argparse.ArgumentParser, args: argparse.Namespace) -> None:
    ...
    if pure_test and (
        ...
        or getattr(args, "codex_use_packaged_omp_default_routing", False)
        or args.root
    ):
